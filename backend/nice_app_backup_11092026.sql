...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-09-2026 a las 16:20:25
...
INSERT INTO `empresarias` (`IdEmpresaria`, `Nombre`, `Telefono`, `PorcentajeDescuento`, `Estado`, `created_at`) VALUES
(1, 'Empresaria Principal', NULL, 40.00, 'Activa', '2026-09-11 14:20:07');
...
--
ALTER TABLE `empresarias`
  MODIFY `IdEmpresaria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
